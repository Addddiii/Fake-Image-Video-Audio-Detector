...
export default function LoginPage() {
  ...
  return (
    <>
      <Head>
        <title>Login | LatFakeCheck</title>
      </Head>
      ...
      <main className="min-h-screen bg-gradient-to-b from-[#020617] via-[#0B1120] to-[#0F172A]">
        ...
        <div className="max-w-6xl mx-auto px-8 pt-12 pb-12">
          <div className="max-w-md mx-auto bg-[#111827]/90 backdrop-blur-sm rounded-2xl border border-white/10 shadow-2xl p-6">
            ...
            {checkingAuth ? (
              <div className="mt-6 rounded-xl border border-white/10 bg-[#020617]/70 px-4 py-6 text-center text-sm text-slate-400">
              ...
              <>
                ...
                <div className="mt-6 flex flex-col gap-3">
                  <button
                    ...
                    disabled={loading}
                    className="w-full rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-white hover:bg-white/10 transition flex items-center justify-center gap-3 disabled:opacity-70"
                  >
                    <GoogleIcon />
